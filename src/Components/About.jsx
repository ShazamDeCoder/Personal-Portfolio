      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white max-w-4xl mx-auto leading-relaxed">
              I'm Mubarak, a <strong>Frontend Developer</strong> passionate about  building <strong>modern web applications</strong>. I specialize in <strong>HTML, CSS, JavaScript, React, and Tailwind CSS</strong> and love creating seamless user experiences that combine beautiful design with robust functionality.
          </p>
        </div>
