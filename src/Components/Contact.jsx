...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 px-6 md:px-12 lg:px-20 bg-black relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          {/* Contact Form */}
          <div className="border-2 border-red-600 p-6 md:p-8 rounded-lg shadow-md relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className="w-full p-3 sm:p-4 text-white border-2 border-red-600 rounded focus:outline-none text-sm sm:text-base"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="w-full p-3 sm:p-4 border-2 text-white rounded border-red-600 resize-none focus:outline-none text-sm sm:text-base"
              />
              <button
                type="submit"
                className="flex items-center justify-center w-full p-3 sm:p-4 bg-red-600 text-white rounded-full hover:bg-white hover:text-red-600 transition text-sm sm:text-base"
              >
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4 ">
              {contactInfo.map((item, index) => (
                <a
                  key={index}
                  href={item.href}
                  className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 border-2 border-red-600 rounded hover:shadow-md transition text-sm sm:text-base"
                >
                  <div className="text-white text-lg sm:text-xl">{item.icon}</div>
                  <div>
                    <div className="text-xs sm:text-sm text-white">{item.label}</div>
                    <div className="font-medium text-white text-sm sm:text-base">{item.value}</div>
                  </div>
                </a>
              ))}
            </div>
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-sm sm:text-lg font-semibold mb-2 sm:mb-4 text-white">Follow Me</h4>
              <div className="flex gap-2 sm:gap-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="p-2 sm:p-3 border-2 border-red-600 rounded text-white hover:text-red-600 hover:shadow-md transition text-base sm:text-lg"
